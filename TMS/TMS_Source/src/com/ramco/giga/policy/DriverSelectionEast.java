...
/**
 */
public class DriverSelectionEast extends JITResourceSelection {
	...
	public PlacementResult evaluatePlacements(WorkflowElement workflowElement,
		...
		// do the search
			...
			long LatestEnd = timeRelation.getEarliest(workflowElement, TimeDirection.TIMEDIRECTION_BACKWARD);
